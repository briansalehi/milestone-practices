#############################################################################
# Makefile for building: table-view.bin
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  table-view.pro
# Template: app
# Command: /usr/bin/qmake -o table-view.make table-view.pro
#############################################################################

MAKEFILE      = table-view.make
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = table-view.bin1.0.0
DISTDIR = /home/brian/development/projects/milestone-practices/cxx/gui/widgets/.tmp/table-view.bin1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = table-view.cxx 
OBJECTS       = table-view.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		table-view.pro  table-view.cxx
QMAKE_TARGET  = table-view.bin
DESTDIR       = 
TARGET        = table-view.bin


first: all
####### Build rules

table-view.bin:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

table-view.make: table-view.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		table-view.pro
	$(QMAKE) -o table-view.make table-view.pro
...
all: table-view.make table-view.bin
...
distdir: FORCE
	...
	$(COPY_FILE) --parents table-view.cxx $(DISTDIR)/
...
table-view.o: table-view.cxx 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o table-view.o table-view.cxx
