...
<table class="table table-dark">
	...
	<tbody>
		...
		<tr>
			...
			<td>Sorts elements in a range using a specified sort criterion, which is a binary predicate that supplies a strict-weak– ordering. <code>sort</code> might change relative positions of equivalent elements.</td>
		</tr>
		<tr>
