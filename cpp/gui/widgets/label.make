#############################################################################
# Makefile for building: label.bin
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  label.pro
# Template: app
# Command: /usr/bin/qmake -o label.make label.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = label.bin1.0.0
DISTDIR = /home/brian/development/projects/milestone-practices/cxx/gui/widgets/.tmp/label.bin1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
label.make: label.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents label.cxx $(DISTDIR)/
...
label.o: label.cxx 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o label.o label.cxx
