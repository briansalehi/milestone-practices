#############################################################################
# Makefile for building: custom-signals.bin
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  custom-signals.pro
# Template: app
# Command: /usr/bin/qmake -o custom-signals.make custom-signals.pro
#############################################################################

MAKEFILE      = custom-signals.make
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = custom-signals.bin1.0.0
DISTDIR = /home/brian/development/projects/milestone-practices/cpp/gui/fundamentals/.tmp/custom-signals.bin1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = custom-signals.cxx \
		custom-signals-mainwindow.cxx moc_custom-signals-mainwindow.cpp
OBJECTS       = custom-signals.o \
		custom-signals-mainwindow.o \
		moc_custom-signals-mainwindow.o
...
DESTDIR       = 
TARGET        = custom-signals.bin


first: all
####### Build rules

custom-signals.bin:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

custom-signals.make: custom-signals.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		custom-signals.pro
	$(QMAKE) -o custom-signals.make custom-signals.pro
...
all: custom-signals.make custom-signals.bin
...
custom-signals.o: custom-signals.cxx custom-signals-mainwindow.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o custom-signals.o custom-signals.cxx

custom-signals-mainwindow.o: custom-signals-mainwindow.cxx custom-signals-mainwindow.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o custom-signals-mainwindow.o custom-signals-mainwindow.cxx

moc_custom-signals-mainwindow.o: moc_custom-signals-mainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_custom-signals-mainwindow.o moc_custom-signals-mainwindow.cpp
