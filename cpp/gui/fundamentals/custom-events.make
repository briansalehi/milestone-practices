#############################################################################
# Makefile for building: custom-events.bin
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  custom-events.pro
# Template: app
# Command: /usr/bin/qmake -o custom-events.make custom-events.pro
#############################################################################

MAKEFILE      = custom-events.make
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = custom-events.bin1.0.0
DISTDIR = /home/brian/development/projects/milestone-practices/cpp/gui/fundamentals/.tmp/custom-events.bin1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = custom-events.cxx \
		custom-events-mainwindow.cxx \
		custom-events-textedit.cxx moc_custom-events-mainwindow.cpp \
		moc_custom-events-textedit.cpp
OBJECTS       = custom-events.o \
		custom-events-mainwindow.o \
		custom-events-textedit.o \
		moc_custom-events-mainwindow.o \
		moc_custom-events-textedit.o
...
QMAKE_TARGET  = custom-events.bin
DESTDIR       = 
TARGET        = custom-events.bin


first: all
####### Build rules

custom-events.bin:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

custom-events.make: custom-events.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		custom-events.pro
	$(QMAKE) -o custom-events.make custom-events.pro
...
all: custom-events.make custom-events.bin
...
custom-events.o: custom-events.cxx custom-events-mainwindow.hpp \
		custom-events-textedit.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o custom-events.o custom-events.cxx

custom-events-mainwindow.o: custom-events-mainwindow.cxx custom-events-mainwindow.hpp \
		custom-events-textedit.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o custom-events-mainwindow.o custom-events-mainwindow.cxx

custom-events-textedit.o: custom-events-textedit.cxx custom-events-textedit.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o custom-events-textedit.o custom-events-textedit.cxx

moc_custom-events-mainwindow.o: moc_custom-events-mainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_custom-events-mainwindow.o moc_custom-events-mainwindow.cpp

moc_custom-events-textedit.o: moc_custom-events-textedit.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_custom-events-textedit.o moc_custom-events-textedit.cpp
