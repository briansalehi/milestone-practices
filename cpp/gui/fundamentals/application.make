#############################################################################
# Makefile for building: application.bin
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  application.pro
# Template: app
# Command: /usr/bin/qmake -o application.make application.pro
#############################################################################

MAKEFILE      = application.make
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = application.bin1.0.0
DISTDIR = /home/brian/development/projects/milestone-practices/cpp/gui/fundamentals/.tmp/application.bin1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		application.pro  application.cxx
QMAKE_TARGET  = application.bin
DESTDIR       = 
TARGET        = application.bin


first: all
####### Build rules

application.bin:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

application.make: application.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		application.pro
	$(QMAKE) -o application.make application.pro
...
all: application.make application.bin
...
distdir: FORCE
	...
	$(COPY_FILE) --parents application.cxx $(DISTDIR)/
...
application.o: application.cxx 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o application.o application.cxx
