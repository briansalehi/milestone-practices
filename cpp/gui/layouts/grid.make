#############################################################################
# Makefile for building: grid.bin
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  grid.pro
# Template: app
# Command: /usr/bin/qmake -o grid.make grid.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = grid.bin1.0.0
DISTDIR = /home/brian/development/projects/milestone-practices/cxx/gui/layouts/.tmp/grid.bin1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
grid.make: grid.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents grid.cxx $(DISTDIR)/
...
grid.o: grid.cxx 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o grid.o grid.cxx
